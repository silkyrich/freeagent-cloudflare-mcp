/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dcad601f2f8eda5487aa5d7edb1a7ecb)
// Runtime types generated with workerd@1.20260630.1 2025-06-01 nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	FREEAGENT_CLIENT_ID: string;
	FREEAGENT_CLIENT_SECRET: string;
	COOKIE_ENCRYPTION_KEY: string;
	MCP_OBJECT: DurableObjectNamespace<import("./src/index").FreeAgentMCP>;
	TOKEN_STORE: DurableObjectNamespace<import("./src/index").TokenStore>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "FreeAgentMCP" | "TokenStore";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FREEAGENT_CLIENT_ID" | "FREEAGENT_CLIENT_SECRET" | "COOKIE_ENCRYPTION_KEY">> {}
}
